...
class AsyncOperationMonitor:
    ...
    def timed(self, func: typing.Callable[..., typing.Coroutine[typing.Any, typing.Any, typing.Any]]) -> typing.Callable[..., typing.Coroutine[typing.Any, typing.Any, typing.Any]]:
    ...
    def _update_stats(self, name: str, duration: float, success: bool) -> None:
        ...
        if name not in self.stats:
            self.stats[name] = {"calls": 0, "success": 0, "failure": 0, "total_duration": 0.0}
